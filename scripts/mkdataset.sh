...
for seed in ${seeds[@]}
    do
    python generate_SC_dataset.py ../data/hmdb51/ ../tools/data/hmdb51/label_map.txt SC_hmdb51_${num_classes}cls_${seed} \
    --n_classes ${num_classes} --n_samples 12 --n_train_ratio 0.5 --seed ${seed}
    done

for seed in ${seeds[@]}
    do
    python generate_SC_dataset.py ../data/ucf101/ ../tools/data/ucf101/label_map.txt SC_ucf101_${num_classes}cls_${seed} \
    --n_classes ${num_classes} --n_samples 12 --n_train_ratio 0.5 --seed ${seed}
    done