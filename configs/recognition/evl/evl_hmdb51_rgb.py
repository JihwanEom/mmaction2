...
ann_file_train = f'data/hmdb51/SC_hmdb51_{num_classes}cls_0/train_list_rawframes.txt'
ann_file_val = f'data/hmdb51/SC_hmdb51_{num_classes}cls_0/val_list_rawframes.txt'
ann_file_test = f'data/hmdb51/SC_hmdb51_{num_classes}cls_0/test_list_rawframes.txt'
# split = 1
# dataset_type = 'RawframeDataset'
# data_root = 'data/hmdb51/rawframes'
# data_root_val = 'data/hmdb51/rawframes'
