...
data_root = 'data/nerthus/rawframes'
data_root_val = 'data/nerthus/rawframes'
ann_file_train = f'data/nerthus/rawframes/train_list_rawframes.txt'
ann_file_val = f'data/nerthus/rawframes/val_list_rawframes.txt'
ann_file_test = f'data/nerthus/rawframes/test_list_rawframes.txt'
# split = 1
# dataset_type = 'RawframeDataset'
...
# runtime settings
work_dir = './work_dirs/EVL_CCD_ViT-B-16_SC'
