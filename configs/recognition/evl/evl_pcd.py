...
data_root = 'data/PCD_motion/rawframes'
data_root_val = 'data/PCD_motion/rawframes'
ann_file_train = f'data/PCD_motion/rawframes/train_list_rawframes.txt'
ann_file_val = f'data/PCD_motion/rawframes/val_list_rawframes.txt'
ann_file_test = f'data/PCD_motion/rawframes/test_list_rawframes.txt'
# split = 1
# dataset_type = 'RawframeDataset'
