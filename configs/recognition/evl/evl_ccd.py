...
data_root = 'data/CCD/rawframes'
data_root_val = 'data/CCD/rawframes'
ann_file_train = f'data/CCD/rawframes/train_list_rawframes.txt'
ann_file_val = f'data/CCD/rawframes/val_list_rawframes.txt'
ann_file_test = f'data/CCD/rawframes/test_list_rawframes.txt'
# split = 1
# dataset_type = 'RawframeDataset'
